...
We calculate the user bias, $b_u$, by grouping the observations by user, subtracting $\mu$ and the respective $b_i$ for each movie, then averaging the results. This produces the following:
...
We see a distinct pattern, with the number of ratings dropping off over time, and the average rating fluctuating in a fairly consistent wave pattern until around the 65 year mark, where the pattern breaks down into chaos.
